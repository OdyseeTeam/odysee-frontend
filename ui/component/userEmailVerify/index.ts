...
import { selectEmailToVerify, selectEmailAlreadyExists, selectUser, selectResendingVerificationEmail, selectUser2FAPending } from "redux/selectors/user";
...
const perform = dispatch => ({
  ...
  toast: message => dispatch(doToast({
    message
  }))
});

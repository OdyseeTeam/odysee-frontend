...
export default function WanderButton(props: Props) {
  ...
  return (
    ...
    >
      <div
        className={`wanderButton${!hideBalance && activeArStatus === 'authenticating' ? ' wanderButton--authenticating' : !hideBalance && activeArStatus === 'authenticated' ? ' wanderButton--authenticated' : !hideBalance && activeArStatus === 'connected' ? ' wanderButton--connected' : ''}${backups > 0 ? ' wanderButton--warning' : ''}`}

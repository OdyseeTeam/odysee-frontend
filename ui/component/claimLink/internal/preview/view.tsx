...
const ClaimLinkPreview = (props: Props) => {
  ...
  const Component = React.useMemo(() => isLivestreamClaim ? (props: any) => <LivestreamComponent {...props} forceRender /> : StreamComponent, [StreamComponent, isLivestreamClaim]);
  const PreviewLinkButton = React.useMemo(() => () => <div className="preview-link__url">

...
const ViewModeSelector = ({
  ...
  return <Menu>
      <MenuButton className="shorts-page-menu__button" onClick={e => {
      e.stopPropagation();
    }}>
      ...
      <MenuList className="menu__list shorts-page__view-menu">
        <MenuItem className={classnames('comment__menu-option', {
        ...
        'comment__menu-option--active': viewMode === 'channel'
          ...
          <div className="menu__link">
            {__('From %channel%', {
            channel: channelName && channelName.length > 20 ? channelName.substring(0, 20) + '...' : channelName || 'Channel'
          })}
          </div>
        </MenuItem>
      </MenuList>

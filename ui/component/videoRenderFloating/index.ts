...
import { selectIsPlayerFloating, selectPrimaryUri, selectPlayingUri, makeSelectFileRenderModeForUri, selectAutoplayCountdownUri, selectCanViewFileForUri } from "redux/selectors/content";
import { selectClientSetting } from "redux/selectors/settings";
import { doClearQueueList } from "redux/actions/collections";
import { doClearPlayingUri, doClearPlayingSource, doSetShowAutoplayCountdownForUri, doSetPlayingUri } from "redux/actions/content";
...
const select = (state, props) => {
  ...
  return {
    ...
    hasClaimInQueue: permanent_url && selectCollectionForIdHasClaimUrl(state, COLLECTIONS_CONSTS.QUEUE_ID, permanent_url),

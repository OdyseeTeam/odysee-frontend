...
const select = (state, props) => ({
  ...
  disableSlimes: makeSelectTagInClaimOrChannelForUri(props.uri, DISABLE_SLIMES_ALL_TAG)(state) || makeSelectTagInClaimOrChannelForUri(props.uri, DISABLE_SLIMES_VIDEO_TAG)(state),
  disableReactions: makeSelectTagInClaimOrChannelForUri(props.uri, DISABLE_REACTIONS_ALL_TAG)(state) || makeSelectTagInClaimOrChannelForUri(props.uri, DISABLE_REACTIONS_VIDEO_TAG)(state)
});

...
import { selectCheapestProtectedContentMembershipForId, selectIsMembershipListFetchingForId, selectArEnabledMembershipTiersForChannelUri, selectUserHasValidNonCanceledMembershipForCreatorId } from "redux/selectors/memberships";
...
const select = (state, props) => {
  ...
  const {
    claim_id: claimId
  } = selectClaimForUri(state, props.uri) || {};

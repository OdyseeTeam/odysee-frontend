    ...
    'non-clickable': !uri
      ...
      <div className="entry__content">
        {claim ? <>
            ...
            <div className="entry__label">
              {uri === null ? <span className="entry__title">{'---'}</span> : isResolvingUri || claim === undefined ? <>
      ...
      <div className={classnames('entry__action-icon', {

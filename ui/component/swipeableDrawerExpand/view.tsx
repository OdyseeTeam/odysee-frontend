...
function DrawerExpandButton(props: Props) {
  ...
  return <Wrapper fixed={fixed}>
      ...
      <Button className={classnames('swipeable-drawer__expand-button', {
      fixed
    })} button="primary" icon={icon || (fixed ? ICONS.UP : undefined)} iconSize={fixed && icon ? 30 : undefined} onClick={e => {
      e.preventDefault();
      e.stopPropagation();

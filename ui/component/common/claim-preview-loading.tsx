...
function ClaimPreviewLoading(props: Props) {
  ...
  return (// Uses the same WrapperElement as claimPreview so it's consistent with the rest of the list components
    <WrapperElement className={classnames('placeholder claim-preview__wrapper', {

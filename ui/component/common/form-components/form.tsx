...
export const Form = (props: Props) => {
  ...
  return <form noValidate className="form" onMouseDown={() => pressedEnter.current = false} onKeyDown={event => pressedEnter.current = event.keyCode === KEYCODES.ENTER} onSubmit={event => {

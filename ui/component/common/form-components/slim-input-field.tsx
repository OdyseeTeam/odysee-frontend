...
export const TextareaWrapper = (wrapperProps: TextareaWrapperProps) => {
  ...
  return slimInput ? !isDrawerOpen ? <div ref={slimInputButtonRef} role="button" onClick={toggleDrawer}>
        {children}
      </div> : <Drawer className="comment-create--drawer" anchor="bottom" open onClose={handleCloseAll} // The Modal tries to enforce focus when open and doesn't allow clicking or changing any

...
export const icons = {
  ...
  [ICONS.MEMBERSHIP]: buildIcon(
    ...
    >
      ...
      <path
        className="membership--st0"
        d="M12.8,8c-0.2,0-0.4,0.2-0.4,0.4s0.2,0.4,0.4,0.4c1.4,0,1.4,0.8,1.4,1.1v1.2c0,0.2,0.2,0.4,0.4,0.4
      s0.4-0.2,0.4-0.4V9.9C15,8.7,14.2,8,12.8,8z M3.8,16.2c0,0,8.1,4.7,8.2,4.7c0,0,7.9-4.6,7.9-4.6l-1.7-1v-4.9c0-0.8-0.1-1.5-0.3-2.2
      c0,0-1.2-3.9-5.8-3.9S5.7,8,5.7,10.4v4.9l-0.8,0.4L3.8,16.2z M16.5,12c0,1.8-1.7,2.5-3.6,2.5h-1.7c-1.9,0-3.5-0.7-3.5-2.5V9.9
      c0-2.4,1.8-3.4,4.4-3.4c2.5,0,4.4,1,4.4,3.4L16.5,12z M12,0C5.4,0,0,5.4,0,12s5.4,12,12,12s12-5.4,12-12S18.6,0,12,0z M12,22.9
      C6,22.9,1.1,18,1.1,12S6,1.1,12,1.1S22.9,6,22.9,12S18,22.9,12,22.9z"
      />
    </svg>
  ),

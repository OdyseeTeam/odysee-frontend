...
export const icons = {
  ...
  // *** Markdown Editor Icons From https://remixicon.com/ ***
  [ICONS.BOLD]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;

    return (
      <svg {...otherProps} width={size} height={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  [ICONS.ITALIC]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;

    return (
      <svg {...otherProps} width={size} height={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path fill="none" d="M0 0h24v24H0z" />
        <path fill={color} d="M15 20H7v-2h2.927l2.116-12H9V4h8v2h-2.927l-2.116 12H15z" />
      </svg>
    );
  },
  [ICONS.STRIKE_THROUGH]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;
  ...
  [ICONS.HEADING_1]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;

    return (
      <svg {...otherProps} width={size} height={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path fill="none" d="M0 0H24V24H0z" />
        <path fill={color} d="M13 20h-2v-7H4v7H2V4h2v7h7V4h2v16zm8-12v12h-2v-9.796l-2 .536V8.67L19.5 8H21z" />
      </svg>
    );
  },
  [ICONS.HEADING_2]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;
  ...
  [ICONS.HEADING_3]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;
  ...
  [ICONS.HEADING_4]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;
  ...
  [ICONS.HEADING_5]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;
  ...
  [ICONS.HEADING_6]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;
  ...
  [ICONS.BULLET_LIST]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;
  ...
  [ICONS.ORDERED_LIST]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;
  ...
  [ICONS.CODE_BLOCK]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;
  ...
  [ICONS.BLOCKQUOTE]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;
  ...
  [ICONS.HORIZONTAL_RULE]: (props: IconProps) => {
    const { size = 24, color = 'currentColor', ...otherProps } = props;

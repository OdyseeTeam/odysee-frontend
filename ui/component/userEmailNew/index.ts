...
import { selectEmailNewIsPending, selectEmailNewErrorMessage, selectEmailAlreadyExists, selectUser } from "redux/selectors/user";
...
const perform = dispatch => ({
  ...
  setShareDiagnosticData: shouldShareData => dispatch(doSetDaemonSetting(DAEMON_SETTINGS.SHARE_USAGE_DATA, shouldShareData)),

...
import { selectClaimIsMine, selectClaimForUri, selectHasChannels, makeSelectTagInClaimOrChannelForUri, selectClaimIsNsfwForUri, selectPreorderTagForUri, selectProtectedContentTagForUri, selectIsFiatRequiredForUri, selectIsFiatPaidForUri, selectPurchaseMadeForClaimId, selectCostInfoForUri, selectScheduledStateForUri } from "redux/selectors/claims";
...
const select = (state, props) => {
  ...
  return {
    claim,
    disableFileReactions: makeSelectTagInClaimOrChannelForUri(uri, DISABLE_REACTIONS_ALL_TAG)(state) || makeSelectTagInClaimOrChannelForUri(uri, DISABLE_REACTIONS_VIDEO_TAG)(state),

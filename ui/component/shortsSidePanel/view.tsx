...
const ShortsSidePanel = React.memo<Props>(({
  ...
  return <div className={`shorts-page__side-panel ${isOpen ? 'shorts-page__side-panel--open' : ''}`}>
        <div className="shorts-page__close-button-container">
          <Button className="shorts-page__close-button" onClick={onClose} icon={ICONS.REMOVE} iconSize={20} title={'Close'} />
        </div>

...
import { selectBalance, selectTotalBalance, selectClaimsBalance, selectSupportsBalance, selectTipsBalance, selectAbandonClaimSupportError } from "redux/selectors/wallet";
...
const perform = dispatch => ({
  abandonSupportForClaim: (claimId, type, keep, preview) => dispatch(doSupportAbandonForClaim(claimId, type, keep, preview))
});

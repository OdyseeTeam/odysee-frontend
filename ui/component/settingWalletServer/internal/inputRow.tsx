...
function ServerInputRow(props: Props) {
  ...
  return <Form onSubmit={onSubmit}>
      <div className="section__actions">
        <FormField type="text" label={__('Host')} placeholder={'code.freezepeach.fun'} value={hostString} onChange={e => setHostString(e.target.value)} />
        <span className="form-field__conjuction">:</span>
        <FormField type="number" label={__('Port')} placeholder={'50001'} value={portString} onChange={e => setPortString(String(e.target.value))} />
      </div>

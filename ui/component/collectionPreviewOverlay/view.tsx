...
function CollectionPreviewOverlay(props: Props) {
  ...
  if (!collectionItemUrls || collectionItemUrls.length === 0 || collectionItemUrls.length === 1 && !collectionThumbnail) {
    return null;
  }
  ...
  return <div className="claim-preview__collection-wrapper">
      <ul className="ul--no-style collection-preview-overlay__grid">
        {displayedItems.map(uri => <li className="li--no-style collection-preview-overlay__grid-item" key={uri}>

...
type Props = {
  ...
  getActionButtons?: (url: string) => React.ReactNode;
...
export default function BlockList(props: Props) {
  ...
  function filterSearchResults(results: Array<string> | null | undefined) {
...
type LsbProps = {
  ...
  onResultsUpdated?: (arg0: Array<string> | null | undefined) => void;
};

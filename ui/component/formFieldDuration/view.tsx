...
type Props = {
  ...
  onResolve: (valueInSeconds: number) => void;
  // Returns parsed/resolved value in seconds; "-1" for invalid input.
...
export default function FormFieldDuration(props: Props) {
  ...
  return <FormField name={name} type="text" disabled={disabled} label={<>
        ...
        </>} placeholder={placeholder || '30s, 10m, 1h, 2d, 3month, 1y'} value={value} onChange={onChange} error={valueErr} />;
}
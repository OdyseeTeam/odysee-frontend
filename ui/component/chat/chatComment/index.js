...
import { selectMyMembershipNameForCreatorId, selectUserOdyseeMembership } from 'redux/selectors/memberships';
...
const select = (state, props) => {
  ...
  return {
    ...
    creatorMembership: selectMyMembershipNameForCreatorId(state, creatorId),
    activeChannelClaim,
    authorTitle,
    channelAge,
  };

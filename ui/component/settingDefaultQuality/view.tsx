...
type Props = {
  ...
  doSetDefaultVideoQuality: (value: string | null | undefined) => void;
};
export default function SettingDefaultQuality(props: Props) {
  ...
  return <FormField name="default_video_quality" type="select" onChange={handleSetQuality} value={defaultQuality || valueRef.current}>
      {dropdownOptions.map(option => {
      return <option key={String(option)} value={option}>

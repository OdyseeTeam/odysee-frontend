...
import { DISABLE_REACTIONS_ALL_TAG, DISABLE_SLIMES_ALL_TAG, DISABLE_SLIMES_COMMENTS_TAG, DISABLE_REACTIONS_COMMENTS_TAG } from "constants/tags";
...
const select = (state, props) => {
  ...
  return {
    claim,
    disableReactions: makeSelectTagInClaimOrChannelForUri(props.uri, DISABLE_REACTIONS_ALL_TAG)(state) || makeSelectTagInClaimOrChannelForUri(props.uri, DISABLE_REACTIONS_COMMENTS_TAG)(state),
    disableSlimes: makeSelectTagInClaimOrChannelForUri(props.uri, DISABLE_SLIMES_ALL_TAG)(state) || makeSelectTagInClaimOrChannelForUri(props.uri, DISABLE_SLIMES_COMMENTS_TAG)(state),

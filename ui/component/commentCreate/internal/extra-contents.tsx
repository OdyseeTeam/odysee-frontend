...
export const FormChannelSelector = (selectorProps: SelectorProps) => {
  ...
  return <div className="comment-create__label-wrapper">
...
export const HelpText = (helpTextProps: HelpTextProps) => {
  ...
  return <>
      ...
      {(!!minAmount || !!minUSDAmount) && <div className="help--notice comment-create__min-amount-notice">
          ...
          <Icon customTooltipText={minTip || minUSDTip ? __('This channel requires a minimum tip for each comment.') : minSuper || minUSDSuper ? __('This channel requires a minimum amount for HyperChats to be visible.') : ''} className="icon--help" icon={ICONS.HELP} tooltip size={16} />
        </div>}
    </>;
};
...
export const StickerReviewBox = (props: Props) => {
  ...
  return <div className="comment-create__sticker-preview">
      ...
      {Boolean(price && exchangeRate) && <FilePrice customPrices={{
      // TODO PRICE FILE
      priceFiat: price,
...
export const StickerActionButton = (stickerButtonProps: StickerButtonProps) => {
  ...
  return <Button disabled={disabled} {...buttonProps} title={__('Stickers')} label={isReviewingStickerComment ? __('Change') : undefined} />;
};
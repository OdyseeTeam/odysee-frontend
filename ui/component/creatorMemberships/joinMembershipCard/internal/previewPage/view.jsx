...
export default function PreviewPage(props: Props) {
  ...
  if (channelIsMine) {
    hasntCreatedChannelsText =
      "Unfortunately you haven't activated your memberships functionality yet, but you can do so now at the link below";
  } else {
    hasntCreatedChannelsText =
      "Unfortunately, this creator hasn't activated their membership functionality yet, but you can create your own memberships with the link below";
  }
        ...
        isChannelTab ? (
          <div className="membership-join-blocks__div">
                    ...
                    <div className={classnames('tierInfo', { expandedBlock: expandedTabs[i] })}>
                      ...
                      {membership.Perks && membership.Perks.length > 0 && (
                        <section className="membership__plan-perks">
                          <h1 className="membership-join__plan-header" style={{ marginTop: '17px' }}>
                            {__('Perks')}
                          </h1>
            ...
            {!seeAllTiers && creatorMemberships && creatorMemberships.length > 3 && (
              <>
                ...
                <h1 className="see-all-tiers__header" onClick={(e) => showAllTiers(e)}>
                  See More
                </h1>
              </>
            )}
          ...
          <>
            ...
            <div className="membership-join__body">
              ...
              <section className="membership__plan-perks">
                <h1 className="membership-join__plan-header" style={{ marginBottom: '5px' }}>
                  {__('Perks')}
                </h1>
                <ul className="membership-join-perks__list">
        ...
        {shouldDisablePurchase ? (
          ...
          !isChannelTab && (
            <>
              ...
              {checkingOwnMembershipCard && (
                <h1 style={{ marginTop: '20px' }}>You're not able to signup for your own memberships</h1>
              )}
            </>
          )
        )}

...
import { selectPublishFormValues, selectIsStillEditing, selectMemberRestrictionStatus, selectPublishFormValue, selectMyClaimForUri, selectPrevFileSizeTooBig } from "redux/selectors/publish";
import { selectIsStreamPlaceholderForUri } from "redux/selectors/claims";
import * as RENDER_MODES from "constants/file_render_modes";
import * as SETTINGS from "constants/settings";
import { doClaimInitialRewards } from "redux/actions/rewards";
import { selectUnclaimedRewardValue, selectIsClaimingInitialRewards, selectHasClaimedInitialRewards } from "redux/selectors/rewards";
...
const select = state => {
  ...
  return { ...selectPublishFormValues(state),

...
class LicenseType extends React.PureComponent<Props> {
  constructor() {
    super();
    (this as any).handleLicenseOnChange = this.handleLicenseOnChange.bind(this);
  }
  ...
  render() {
    ...
    return <React.Fragment>
        <FormField name="license" label={__('License (Optional)')} type="select" value={licenseType} onChange={this.handleLicenseOnChange}>
        ...
        {licenseType === COPYRIGHT && <FormField label={__('Copyright notice')} type="text" name="copyright-notice" value={otherLicenseDescription} onChange={handleLicenseDescriptionChange} />}

        {licenseType === OTHER && <fieldset>
            <div className="form-field__help">{__('Provide a description and link to your license')}</div>
            <fieldset-group>
              <FormField label={__('License description')} placeholder={__("The 'cool' license - TM")} type="text" name="other-license-description" value={otherLicenseDescription} onChange={handleLicenseDescriptionChange} />

              <FormField label={__('License URL')} placeholder={__('mywebsite.com/license')} type="text" name="other-license-url" value={licenseUrl} onChange={handleLicenseUrlChange} />
            </fieldset-group>
          </fieldset>}
      </React.Fragment>;
  }

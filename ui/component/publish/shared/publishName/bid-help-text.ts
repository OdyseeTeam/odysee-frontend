...
function BidHelpText(props: Props) {
  ...
  if (uri) {
    if (isResolvingUri) {
      ...
      bidHelpText = __('If you bid more than %amount% LBRY Credits, when someone navigates to %uri%, it will load your published content. However, you can get a longer version of this URL for any bid.', {

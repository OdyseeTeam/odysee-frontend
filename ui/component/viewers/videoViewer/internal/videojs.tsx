...
export type Player = {
  ...
  // -- plugins ---
  mobileUi: (arg0: any) => void;
  chromecast: (arg0: any) => void;
  overlay: (arg0: any) => void;
  hlsQualitySelector: any | null | undefined;
  i18n: (arg0: any) => void;
  // -- base videojs --
  controlBar: {
    addChild: (arg0: string | any, arg1: any | null | undefined, arg2: number | null | undefined) => void;
    getChild: (arg0: string) => void;
    removeChild: (arg0: string) => void;
  };
  loadingSpinner: any;
  autoplay: (arg0: any) => boolean;
  tech: (arg0: boolean | null | undefined) => {
    vhs: any | null | undefined;
  };
  clearInterval: (id: number) => void;
  currentTime: (arg0: number | null | undefined) => number;
  dispose: () => void;
  duration: () => number;
  ended: () => boolean;
  error: () => any;
  exitFullscreen: () => boolean;
  getChild: (arg0: string) => any;
  isFullscreen: () => boolean;
  muted: (arg0: boolean | null | undefined) => boolean;
  on: (arg0: string, arg1: (arg0: any) => void) => void;
  off: (arg0: string, arg1: ((arg0: any) => void) | null | undefined) => void;
  one: (arg0: string, arg1: (arg0: any) => void) => void;
  play: () => Promise<any>;
  playbackRate: (arg0: number | null | undefined) => number;
...
type Props = {
  ...
  internalFeatureEnabled: boolean | null | undefined;
  isAudio: boolean;
  ...
  onPlayerReady: (arg0: Player, arg1: any) => void;
  playNext: () => void;
  playPrevious: () => void;
  ...
  userClaimId: string | null | undefined;
...
export default React.memo<Props>(function VideoJs(props: Props) {
  ...
  useEffect(() => {
    (async function () {
      ...
      (document as any).addEventListener('visibilitychange', keyStateResetHandler);

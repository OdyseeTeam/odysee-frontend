...
const DISPLAY_ORDER = ['PlaybackRateSettingItem', VJS_COMP.KEYBOARD_SHORTCUTS_MENU_ITEM, 'AutoPlayNextMenuItem', 'LoopMenuItem', 'SnapshotMenuItem'];
// ****************************************************************************
// settingsMenu
// ****************************************************************************
type Options = {};
...
function onPlayerReady(player: Player, options: Options) {// Future placeholder for things like dynamic placement (mobile vs. desktop).
}

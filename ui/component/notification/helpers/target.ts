 ...
 * @returns {string}
 */
export function getNotificationLink(notification: WebNotification, target: string | null | undefined) {
...
export function getNotificationLocation(notification: WebNotification, target: string | null | undefined) {

...
import { RULE, CHANNEL_NAME_AT_SENTENCE_START_REGEX, MEMBERSHIP_NAME_AT_SENTENCE_END_REGEX } from "constants/notifications";
...
export function generateNotificationText(rule: string, notificationParams: any) {
  switch (rule) {
    ...
    case RULE.FIAT_TIP:
      return <div className="notification__text" title={replaceLbcWithCredits(notificationParams.device.text)}>
    ...
    case RULE.NEW_MEMBER:
      {
        ...
        return <I18nMessage tokens={{
          new_member_name: memberName || __('An anonymous user'),
    ...
    case RULE.COMMENT_REPLY:
      {
        ...
        return <div className="notification__text notification__text--replies" title={sticker ? undefined : commentText}>
          {sticker && <div className="sticker__comment">

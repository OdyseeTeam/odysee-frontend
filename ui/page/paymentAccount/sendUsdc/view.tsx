...
function SendUsdc(props: any) {
  ...
  return <Card className={!arWalletStatus ? `card--sendusdc card--disabled` : `card--sendusdc`} title={cardHeader()} background actions={<>
          <div className="sendusdc-row">
            ...
            <div className="sendusdc-row__network">
              ...
              <div className="network-selector">
                ...
                return <MenuItem key={index} onSelect={() => setTargetNetwork(network)}>
                          <div className={classnames('channel-selector__item', {

...
function ArWallets(props: Props) {
  ...
  return <Card className={activeArStatus !== 'connected' ? `card--arwalllets card--disabled` : `card--arwalllets`} title={cardHeader()} background actions={<>
        ...
        return <div className={wallet.address === activeAddress ? `wallet-table-row` : `wallet-table-row wallet-table-row--disconnected`} key={wallet.address}>
                  ...
                  <div className="wallet-table-row__default">
                    {wallet.default ? <img src="https://thumbs.odycdn.com/8ee966185b537b147fb7be4412b6bc68.webp" /> : <img src="https://thumbs.odycdn.com/bd2adbec2979b00b1fcb6794e118d5db.webp" />}
                  </div>
                </div>;
      })}
          </div>

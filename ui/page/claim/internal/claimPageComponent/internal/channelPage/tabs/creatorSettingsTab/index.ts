...
import { doCommentBlockWords, doCommentUnblockWords, doCommentModAddDelegate, doCommentModRemoveDelegate, doCommentModListDelegates, doFetchCreatorSettings, doUpdateCreatorSettings } from "redux/actions/comments";
import { selectSettingsByChannelId, selectFetchingCreatorSettings, selectFetchingBlockedWords, selectModerationDelegatesById, selectMembersOnlyCommentsForChannelId } from "redux/selectors/comments";
...
const perform = dispatch => ({
  ...
  commentModAddDelegate: (modChanId, modChanName, creatorChannelClaim) => dispatch(doCommentModAddDelegate(modChanId, modChanName, creatorChannelClaim)),
  commentModRemoveDelegate: (modChanId, modChanName, creatorChannelClaim) => dispatch(doCommentModRemoveDelegate(modChanId, modChanName, creatorChannelClaim)),

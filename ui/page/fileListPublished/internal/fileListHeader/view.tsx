          ...
          <div className="claim-search__wrapper--wrap">
            ...
            <div className="claim-search__menu-group">
              <div className="claim-search__menu-subgroup">
                ...
                {Object.values(FILE_LIST.FILE_TYPE).map((info: FilterInfo) => <Button button="alt" key={info.label} label={__(info.label)} aria-label={info.ariaLabel} onClick={() => handleFilterTypeChange(info.key)} className={classnames(`button-toggle`, `button-toggle__upload-type-filter`, {
        ...
        <div className="section__header-action-stack">
          <div className="section__header--actions">
            <div className="claim-search__wrapper--wrap">
              <div className="claim-search__menu-group">
                <div className="claim-search__menu-subgroup">
                  <Button button="alt" label={__('Refresh')} disabled={fetching} icon={ICONS.REFRESH} onClick={() => {
                  if (method === FILE_LIST.METHOD.CLAIM_LIST) {
                    fetchClaimListMine(1, isFilteringEnabled ? FILE_LIST.PAGE_SIZE_ALL_ITEMS : params.page_size, true, [], true, channelIdsClaimList);
                  } else {
                    doClearClaimSearch();
                  }
                }} />{' '}
                  <div className="claim-search__menu-group enable-filters-checkbox">
                    <FormField label={__('Search & Sort')} name="enable_filters" type="checkbox" checked={isFilteringEnabled} onChange={() => {

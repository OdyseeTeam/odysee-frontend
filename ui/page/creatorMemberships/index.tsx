...
const MembershipsLandingPage = () => {
  ...
  return <Page className="memberships-wrapper">
      ...
      <div className="memberships-content">
        ...
        <HelpHub href="https://help.odysee.tv/category-memberships/" image="LadyFungus" text={__('What are Memberships? Lady Fungus can explain it in the %help_hub%.')} />
      </div>
    </Page>;
};

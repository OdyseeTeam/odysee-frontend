...
const OverviewTab = lazyImport(() => import('./internal/overviewTab'
/* webpackChunkName: "overviewTab" */
));
const TiersTab = lazyImport(() => import('./internal/tiersTab'
/* webpackChunkName: "tiersTab" */
));
const SupportersTab = lazyImport(() => import('./internal/supportersTab'
  ...
  return <Page className="membershipPage-wrapper">
      <div className="creator-header-wrapper">
        ...
        <div className={'right-side'}>
          <Button button={'secondary'} className={!ackInfo ? 'creator-header__ack--active' : 'creator-header__ack--quiet'} label={!ackInfo ? 'X' : 'Help'} onClick={() => {
      ...
      {!ackInfo && <div className={'membership-explainer'}>
          ...
          <div>
            <p>
              {__('Once you connect a new payment wallet, your subscribers will have one week to renew their membership.')}
            </p>
            <p>
              {' '}
            ...
            <p>
              {__('If you need help bulk re-setting up members only content after adding new tiers or making changes, email us at hello@odysee.com')}
            </p>
          </div>
          <Button button={'primary'} label={'Got it'} onClick={() => {
      ...
      <Tabs onChange={onTabChange} index={tabIndex}>
        ...
        <TabPanels>
          <TabPanel>
            <TabWrapper switchToTiersTab={switchToTiersTab} component={<>
                  {!monetizationEnabled && <div className={'help'}>
                      <p>{disabledMessage}</p>
          ...
          <TabPanel>
            <TabWrapper switchToTiersTab={switchToTiersTab} component={<>
                  ...
                  <ChannelSelector hideAnon allOptionProps={{
            ...
            <TabWrapper component={<>
                  ...
                  <div className="create-tiers-header-buttons">
                    <div className="create-tiers-channel-selector">
                      ...
                      <ChannelSelector hideAnon onChannelSelect={() => {
                  setAllSelected(false);
                }} />
                    </div>
                    ...
                    <div className="create-tiers-preview-button">
                      ...
                      <br />
                      <Button navigate={`${formatLbryUrlForWeb(activeChannelClaim?.canonical_url)}?view=membership`} label={__('See Your Memberships')} icon={ICONS.BACK} button="secondary" />
                    </div>
                  </div>

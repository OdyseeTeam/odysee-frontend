...
const PlaylistsPage = (props: Props) => {
  ...
  if (!hasCollections) {
    ...
    if (areBuiltinCollectionsEmpty) {
      ...
      return <Wrapper>
          <Yrbl type="happy" title={__('You can add videos to your Playlists')} subtitle={__('Do you want to find some content to save for later, or create a brand new playlist?')} actions={<div className="section__actions">
    ...
    return <Wrapper>
        <Yrbl type="sad" title={__('You have no Playlists yet. Better start hoarding!')} actions={<div className="section__actions">

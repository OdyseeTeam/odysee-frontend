...
const select = (state, props) => {
  ...
  return {
    collectionCount: collectionId === COLLECTIONS_CONSTS.WATCH_LATER_ID ? selectCountForCollectionIdNonDeleted(state, collectionId) : selectCountForCollectionId(state, collectionId)
  };
};

...
const FilteredTextLabel = () => {
  ...
  return <div className="collection-grid__results-summary">
      {__(filteredCollectionsLength > 1 ? 'Showing %filtered% results of %total%' : 'Showing %filtered% result of %total%', {

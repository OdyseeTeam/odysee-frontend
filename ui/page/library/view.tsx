...
function LibraryPage(props: Props) {
  ...
  return <Page noFooter noSideNavigation settingsPage backout={{
    ...
    backLabel: __('Back')
      ...
      {loading && !hasDownloads && <div className="main--empty">
          <Spinner delayed />
        </div>}

      {!loading && !hasDownloads && <div className="main--empty">
          <Yrbl title={IS_WEB ? __("You haven't purchased anything yet") : __("You haven't downloaded anything from LBRY yet")} actions={<div className="section__actions">

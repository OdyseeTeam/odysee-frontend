...
type Props = {
  claim: StreamClaim;
  uri: string;
  doCommentSocketConnectAsCommenter: (arg0: string, arg1: string, arg2: string, arg3: boolean | null | undefined) => void;
...
export default function PopoutChatPage(props: Props) {
  ...
  return <Page noSideNavigation noFooter noHeader isPopoutWindow>

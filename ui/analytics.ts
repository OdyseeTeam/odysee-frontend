...
export type Analytics = {
  ...
  setUser: (arg0: Record<string, any>) => void;
  apiLog: ApiLog;
  // Legacy logging interface that uses internal-apis.
  event: Events;
  // General event-logging. Currently inactive.
  video: Watchman;
  // AV-playback logging through Watchman.
  error: (arg0: string) => Promise<any>;
   ...
   */
  log: (error: Error | string, options?: LogOptions, label?: string) => Promise<LogId | null | undefined>;
};
// ****************************************************************************
// ****************************************************************************

...
export const makeSelectMyPurchasesForPage = (query: string | null | undefined, page: number = 1) =>
  createSelector(
    selectMyPurchases,
    selectClaimsByUri,
    (myPurchases: Array<string>, claimsByUri: Record<string, Claim>) => {
      if (!myPurchases) {
        return undefined;
      }
...
export const selectClaimIsNsfwForUri = createCachedSelector(
  selectClaimForUri, // Eventually these will come from some list of tags that are considered adult
...
export const selectCanReceiveTipsForUri = createCachedSelector(
  ...
  (claim: Claim | null | undefined, state: State) => {
...
export const selectPurchaseTagForUri = createCachedSelector(
  ...
  (
    metadata: GenericMetadata | null | undefined,
    costInfo: any | null | undefined,
    canReceiveTips: boolean | null | undefined
  ) => {
    return (
...
export const selectPreorderTagForUri = createCachedSelector(
  selectMetadataForUri,
  (metadata: GenericMetadata | null | undefined) => {
...
export const makeSelectSupportsForUri = (uri: string) =>
  createSelector(
    ...
    (byOutpoint, claim: StreamClaim | null | undefined) => {

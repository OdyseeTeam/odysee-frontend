...
const AR_EXCHANGE_RATES_EMPTY = { ar: null };

const selectState = (state: State) => state.arwallet || EMPTY_OBJECT;
...
export const selectArweaveExchangeRates = (state: State) => selectState(state).exchangeRates || AR_EXCHANGE_RATES_EMPTY;

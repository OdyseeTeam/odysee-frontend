...
export const makeSelectNotificationForCommentId = id => createSelector(selectNotifications, notifications => {
  const match = notifications && notifications.find(n => n.notification_parameters && n.notification_parameters.dynamic && n.notification_parameters.dynamic.hash === id);
  return match;
});

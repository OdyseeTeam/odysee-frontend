...
export const selectUserEmail = createSelector(selectUser, user => user ? user.primary_email || user.latest_claimed_email : null);
...
export const selectEmailToVerify = createSelector(selectState, selectUserEmail, (state, userEmail) => state.emailToVerify || userEmail);
export const selectPhoneToVerify = createSelector(selectState, selectUserPhone, (state, userPhone) => state.phoneToVerify || userPhone);
...
export const selectUserIsVerificationCandidate = createSelector(selectUser, user => user && (!user.has_verified_email || !user.is_identity_verified));
...
export const selectUserInviteStatusFailed = createSelector(selectUserInvitesRemaining, () => selectUserInvitesRemaining === null);
 ...
 */
export const selectUserInviteReferralCode = createSelector(selectState, state => state.referralCode ? state.referralCode[0] : '');

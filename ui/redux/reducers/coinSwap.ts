...
export default handleActions(
  {
    [ACTIONS.ADD_COIN_SWAP]: (state: CoinSwapState, action: CoinSwapAddAction): CoinSwapState => {
      ...
      return { ...state, coinSwaps: newCoinSwaps };
    },
    ...
    [ACTIONS.USER_STATE_POPULATE]: (
      ...
      action: {
        data: {
          coinSwapCodes: Array<string> | null | undefined;
        };
      }
    ) => {
      ...
      return { ...state, coinSwaps: getBottomEntries(newCoinSwaps, SWAP_HISTORY_LENGTH_LIMIT) };
    },
  },
  defaultState
);

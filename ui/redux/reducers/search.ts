...
export default handleActions({
  [ACTIONS.SEARCH_START]: (state: SearchState): SearchState => ({ ...state,
    searching: true
  }),
  ...
  [ACTIONS.SEARCH_FAIL]: (state: SearchState): SearchState => ({ ...state,
    searching: false
  }),
  ...
  [ACTIONS.SET_MENTION_SEARCH_RESULTS]: (state: SearchState, action: SearchSuccess): SearchState => ({ ...state,
  ...
  [ACTIONS.FYP_FETCH_FAILED]: (state: SearchState, action: any): SearchState => ({ ...state,

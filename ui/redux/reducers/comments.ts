...
export default handleActions(
  {
    ...
    [ACTIONS.COMMENT_CREATE_COMPLETED]: (state: CommentsState, action: any): CommentsState => {
      ...
      if (!commentedChannelIds.includes(comment.channel_id)) {
        ...
        myCommentedChannelIdsById = { ...state.myCommentedChannelIdsById, [claimId]: commentedChannelIds };
      }
    ...
    [ACTIONS.COMMENT_REACT_FAILED]: (state: CommentsState, action: any): CommentsState => {
      ...
      return { ...state, pendingCommentReactions: Array.from(newReactingTypes) };
    },
    ...
    [ACTIONS.COMMENT_FETCH_MY_COMMENTED_CHANNELS_COMPLETE]: (state: CommentsState, action: any) => {
      ...
      return {
        ...state,
        myCommentedChannelIdsById: { ...state.myCommentedChannelIdsById, [contentClaimId]: commentedChannelIds },
      };
    },
    [ACTIONS.COMMENT_SUPER_CHAT_LIST_FAILED]: (state: CommentsState, action: any) => ({ ...state, isLoading: false }),
    ...
    [ACTIONS.COMMENT_RECEIVED]: (state: CommentsState, action: any) => {
      ...
      return { ...state, byId: commentsByClaimId, commentById: allCommentsById, topLevelCommentsById, superChatsByUri };
    },
    [ACTIONS.COMMENT_ABANDON_STARTED]: (state: CommentsState, action: any) => ({ ...state, isLoading: true }),
    ...
    [ACTIONS.COMMENT_UPDATE_FAILED]: (state: CommentsState, action: any) => ({ ...state, isCmmenting: false }),
    [ACTIONS.COMMENT_PIN_COMPLETED]: (state: CommentsState, action: any) => {
      ...
      return { ...state, commentById, topLevelCommentsById, pinnedCommentsById };
    },
    ...
    [ACTIONS.COMMENT_MODERATION_BLOCK_STARTED]: (state: CommentsState, action: any) => {
      ...
      switch (blockLevel) {
        ...
        case BLOCK_LEVEL.ADMIN:
          return { ...state, blockingByUri: { ...state.blockingByUri, [blockedUri]: true } };
        ...
        case BLOCK_LEVEL.MODERATOR:
          ...
          return { ...state, togglingForDelegatorMap: newMap };
      }
    },
    [ACTIONS.COMMENT_MODERATION_UN_BLOCK_STARTED]: (state: CommentsState, action: any) => {
      ...
      switch (blockLevel) {
        ...
        case BLOCK_LEVEL.SELF:
        case BLOCK_LEVEL.ADMIN:
          return { ...state, unBlockingByUri: { ...state.unBlockingByUri, [blockedUri]: true } };
    ...
    [ACTIONS.COMMENT_MODERATION_BLOCK_FAILED]: (state: CommentsState, action: any) => {
      ...
      switch (blockLevel) {
        ...
        case BLOCK_LEVEL.SELF:
        case BLOCK_LEVEL.ADMIN:
          return { ...state, blockingByUri: { ...state.blockingByUri, [blockedUri]: false } };
    ...
    [ACTIONS.COMMENT_MODERATION_UN_BLOCK_FAILED]: (state: CommentsState, action: any) => {
      ...
      switch (blockLevel) {
        ...
        case BLOCK_LEVEL.SELF:
        case BLOCK_LEVEL.ADMIN:
          return { ...state, unBlockingByUri: { ...state.unBlockingByUri, [blockedUri]: false } };
    ...
    [ACTIONS.COMMENT_MODERATION_BLOCK_COMPLETE]: (state: CommentsState, action: any) => {
      ...
      switch (blockLevel) {
        case BLOCK_LEVEL.SELF: {
          ...
          return { ...state, commentById, blockingByUri, moderationBlockList: newBlockList };
        }
        ...
        case BLOCK_LEVEL.ADMIN:
          ...
          newBlockList.push(blockedUri);
          delete blockingByUri[blockedUri];
          return { ...state, commentById, blockingByUri, adminBlockList: newBlockList };
      }
    },
    [ACTIONS.COMMENT_MODERATION_UN_BLOCK_COMPLETE]: (state: CommentsState, action: any) => {
      ...
      switch (blockLevel) {
        ...
        case BLOCK_LEVEL.ADMIN: {
          const blockList = state.adminBlockList || [];
          delete unBlockingByUri[blockedUri];
          return { ...state, unBlockingByUri, adminBlockList: blockList.slice().filter((uri) => uri !== blockedUri) };
        }
        ...
        case BLOCK_LEVEL.MODERATOR: {
          ...
          return { ...state, moderatorBlockList: newBlockList, togglingForDelegatorMap: togglingMap };
        }
      }
    },
    ...
    [ACTIONS.COMMENT_FETCH_MODERATION_DELEGATES_COMPLETED]: (state: CommentsState, action: any) => {
      ...
      return { ...state, fetchingModerationDelegates: false, moderationDelegatesById: moderationDelegatesById };
    },
    [ACTIONS.COMMENT_MODERATION_DELEGATES_FOR_MY_CHANNELS_COMPLETED]: (state: CommentsState, action: any) => {
      ...
      return { ...state, moderationDelegatesById: moderationDelegatesById };
    },
    ...
    [ACTIONS.COMMENT_FETCH_SETTINGS_COMPLETED]: (state: CommentsState, action: any) => {
      ...
      return { ...state, settingsByChannelId, fetchingSettings: false };
    },
    [ACTIONS.ADD_MODERATOR_COMPLETED]: (state: CommentsState, action: any) => {
      ...
      moderationDelegatesById[creatorChannelId] = Array.isArray(moderationDelegatesById[creatorChannelId])
        ...
        : parsedNewDelegates;
      return { ...state, moderationDelegatesById };
    },
    ...
    [ACTIONS.COMMENT_FETCH_BLOCKED_WORDS_COMPLETED]: (state: CommentsState, action: any) => {
      ...
      return { ...state, settingsByChannelId, fetchingBlockedWords: false };
    },
  },
  defaultState
);

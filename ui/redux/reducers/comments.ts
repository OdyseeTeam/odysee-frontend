...
export default handleActions({
  [ACTIONS.COMMENT_CREATE_STARTED]: (state: CommentsState, action: any): CommentsState => ({ ...state,
    isCommenting: true
  }),
  [ACTIONS.COMMENT_CREATE_FAILED]: (state: CommentsState, action: any) => ({ ...state,
    isCommenting: false
  }),
  [ACTIONS.COMMENT_CREATE_COMPLETED]: (state: CommentsState, action: any): CommentsState => {
    ...
    if (!commentedChannelIds.includes(comment.channel_id)) {
      ...
      myCommentedChannelIdsById = { ...state.myCommentedChannelIdsById,
  ...
  [ACTIONS.COMMENT_REACTION_LIST_STARTED]: (state: CommentsState, action: any): CommentsState => ({ ...state,
    isFetchingReacts: true
  }),
  [ACTIONS.COMMENT_REACTION_LIST_FAILED]: (state: CommentsState, action: any) => ({ ...state,
    isFetchingReacts: false
  }),
  ...
  [ACTIONS.COMMENT_BY_ID_STARTED]: state => ({ ...state,
    isLoadingById: true
  }),
  ...
  [ACTIONS.COMMENT_SUPER_CHAT_LIST_FAILED]: (state: CommentsState, action: any) => ({ ...state,
    isLoading: false
  }),
  [ACTIONS.COMMENT_SUPER_CHAT_LIST_STARTED]: state => ({ ...state,
    isLoading: true
  }),
  [ACTIONS.COMMENT_SUPER_CHAT_LIST_COMPLETED]: (state: CommentsState, action: any) => {
    ...
    return { ...state,
      superChatsByUri: { ...state.superChatsByUri,
        [uri]: {
          comments,
          totalAmount
        }
  ...
  [ACTIONS.COMMENT_LIST_FAILED]: (state: CommentsState, action: any) => ({ ...state,
    isLoading: false
  }),
  ...
  [ACTIONS.COMMENT_ABANDON_STARTED]: (state: CommentsState, action: any) => ({ ...state,
    isLoading: true
  }),
  ...
  [ACTIONS.COMMENT_ABANDON_FAILED]: (state: CommentsState, action: any) => ({ ...state,
    isCommenting: false
  }),
  [ACTIONS.COMMENT_UPDATE_STARTED]: (state: CommentsState, action: any) => ({ ...state,
    isCommenting: true
  }),
  ...
  [ACTIONS.COMMENT_UPDATE_FAILED]: (state: CommentsState, action: any) => ({ ...state,
    isCmmenting: false
  }),
  ...
  [ACTIONS.WEBSOCKET_MEMBERS_ONLY_TOGGLE_COMPLETE]: (state: CommentsState, action: any) => {
    ...
    return { ...state,
      settingsByChannelId: newSettingsByChannelId
    };
  },
  [ACTIONS.COMMENT_MARK_AS_REMOVED]: (state: CommentsState, action: any) => {
    ...
    commentById[comment_id] = { ...commentById[comment_id],
      removed: true
    };
    return { ...state,
      commentById
  ...
  [ACTIONS.COMMENT_MODERATION_BLOCK_LIST_STARTED]: (state: CommentsState, action: any) => ({ ...state,
  ...
  [ACTIONS.COMMENT_MODERATION_BLOCK_LIST_FAILED]: (state: CommentsState, action: any) => ({ ...state,
    fetchingModerationBlockList: false
  }),
  [ACTIONS.COMMENT_MODERATION_BLOCK_STARTED]: (state: CommentsState, action: any) => {
    ...
    switch (blockLevel) {
      ...
      case BLOCK_LEVEL.ADMIN:
        return { ...state,
          blockingByUri: { ...state.blockingByUri,
            [blockedUri]: true
          }
        };
  ...
  [ACTIONS.COMMENT_MODERATION_UN_BLOCK_STARTED]: (state: CommentsState, action: any) => {
    ...
    switch (blockLevel) {
      ...
      case BLOCK_LEVEL.ADMIN:
        return { ...state,
          unBlockingByUri: { ...state.unBlockingByUri,
            [blockedUri]: true
          }
        };
  ...
  [ACTIONS.COMMENT_FETCH_MODERATION_DELEGATES_STARTED]: (state: CommentsState, action: any) => ({ ...state,
    fetchingModerationDelegates: true
  }),
  [ACTIONS.COMMENT_FETCH_MODERATION_DELEGATES_FAILED]: (state: CommentsState, action: any) => ({ ...state,
    fetchingModerationDelegates: false
  }),
  ...
  [ACTIONS.COMMENT_MODERATION_AM_I_LIST_STARTED]: (state: CommentsState, action: any) => ({ ...state,
    fetchingModerationDelegators: true
  }),
  [ACTIONS.COMMENT_MODERATION_AM_I_LIST_FAILED]: (state: CommentsState, action: any) => ({ ...state,
    fetchingModerationDelegators: true
  }),
  ...
  [ACTIONS.COMMENT_FETCH_SETTINGS_STARTED]: (state: CommentsState, action: any) => ({ ...state,
    fetchingSettings: true
  }),
  [ACTIONS.COMMENT_FETCH_SETTINGS_FAILED]: (state: CommentsState, action: any) => ({ ...state,
    fetchingSettings: false
  }),
  [ACTIONS.COMMENT_FETCH_SETTINGS_COMPLETED]: (state: CommentsState, action: any) => {
    ...
    if (partialUpdate) {
      settingsByChannelId[channelId] = { // The existing may contain additional Creator Settings (e.g. 'words')
  ...
  [ACTIONS.ADD_MODERATOR_COMPLETED]: (state: CommentsState, action: any) => {
    ...
    moderationDelegatesById[creatorChannelId] = Array.isArray(moderationDelegatesById[creatorChannelId]) ? moderationDelegatesById[creatorChannelId].concat(parsedNewDelegates) : parsedNewDelegates;
    return { ...state,
      moderationDelegatesById
    };
  },
  [ACTIONS.REMOVE_MODERATOR_COMPLETED]: (state: CommentsState, action: any) => {
    ...
    const moderationDelegatesById = Object.assign({}, state.moderationDelegatesById);
    moderationDelegatesById[creatorChannelId] = Array.isArray(moderationDelegatesById[creatorChannelId]) ? moderationDelegatesById[creatorChannelId].filter(delegate => delegate.channelId !== removedDelegateId) : [];
    return { ...state,
      moderationDelegatesById
    };
  },
  [ACTIONS.COMMENT_FETCH_BLOCKED_WORDS_STARTED]: (state: CommentsState, action: any) => ({ ...state,
    fetchingBlockedWords: true
  }),
  [ACTIONS.COMMENT_FETCH_BLOCKED_WORDS_FAILED]: (state: CommentsState, action: any) => ({ ...state,
    fetchingBlockedWords: false
  }),

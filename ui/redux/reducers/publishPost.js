...
export const publishReducer = handleActions(
  {
    [ACTIONS.UPDATE_PUBLISH_FORM]: (state, action): PostState => {
      const { data } = action;
      return {
        ...state,
        ...data,
    ...
    [ACTIONS.CLEAR_PUBLISH]: (state: PostState): PostState => ({
      ...defaultState,
      uri: undefined,
    ...
    [ACTIONS.PUBLISH_START]: (state: PostState): PostState => ({
      ...state,
      publishing: true,
      publishSuccess: false,
    }),
    [ACTIONS.PUBLISH_FAIL]: (state: PostState): PostState => ({
      ...state,
      publishing: false,
    }),
    [ACTIONS.PUBLISH_SUCCESS]: (state: PostState): PostState => ({
      ...state,
      publishing: false,
      publishSuccess: true,
    }),
    [ACTIONS.DO_PREPARE_EDIT]: (state: PostState, action) => {
    ...
    [ACTIONS.UPDATE_UPLOAD_ADD]: (state: PostState, action) => {
    ...
    [ACTIONS.UPDATE_UPLOAD_PROGRESS]: (state: PostState, action) => {
    ...
    [ACTIONS.UPDATE_UPLOAD_REMOVE]: (state: PostState, action) => {
    ...
    [ACTIONS.REHYDRATE]: (state: PostState, action) => {

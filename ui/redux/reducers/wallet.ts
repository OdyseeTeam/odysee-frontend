...
export const walletReducer = handleActions({
  [ACTIONS.FETCH_TRANSACTIONS_STARTED]: (state: WalletState) => ({ ...state,
  ...
  [ACTIONS.FETCH_TRANSACTIONS_FAILED]: (state: WalletState) => ({ ...state,
    fetchingTransactions: false
  }),
  [ACTIONS.FETCH_ACCOUNT_LIST_STARTED]: (state: WalletState) => ({ ...state,
  ...
  [ACTIONS.FETCH_ACCOUNT_LIST_FAILED]: (state: WalletState) => ({ ...state,
    fetchingAccounts: false,
  ...
  [ACTIONS.PENDING_CONSOLIDATED_TXOS_UPDATED]: (state: WalletState, action) => {
    ...
    if (remove) {
      ...
      return { ...state,
        pendingTxos: Array.from(newPendingSet)
      };
    }
  },
  ...
  [ACTIONS.FETCH_SUPPORTS_STARTED]: (state: WalletState) => ({ ...state,
  ...
  [ACTIONS.GET_NEW_ADDRESS_STARTED]: (state: WalletState) => ({ ...state,
  ...
  [ACTIONS.CHECK_ADDRESS_IS_MINE_STARTED]: (state: WalletState) => ({ ...state,
    checkingAddressOwnership: true
  }),
  [ACTIONS.CHECK_ADDRESS_IS_MINE_COMPLETED]: (state: WalletState) => ({ ...state,
  ...
  [ACTIONS.SEND_TRANSACTION_STARTED]: (state: WalletState) => {
    const newDraftTransaction = { ...state.draftTransaction,
      sending: true
    };
    return { ...state,
  ...
  [ACTIONS.SEND_TRANSACTION_COMPLETED]: (state: WalletState) => Object.assign({}, state, {
    draftTransaction: buildDraftTransaction()
  }),
  ...
  [ACTIONS.SUPPORT_TRANSACTION_STARTED]: (state: WalletState) => ({ ...state,
    sendingSupport: true
  }),
  [ACTIONS.SUPPORT_TRANSACTION_COMPLETED]: (state: WalletState) => ({ ...state,
    sendingSupport: false
  }),
  [ACTIONS.SUPPORT_TRANSACTION_FAILED]: (state: WalletState, action) => ({ ...state,
    error: action.data.error,
    sendingSupport: false
  }),
  [ACTIONS.CLEAR_SUPPORT_TRANSACTION]: (state: WalletState) => ({ ...state,
    sendingSupport: false
  }),
  [ACTIONS.WALLET_STATUS_COMPLETED]: (state: WalletState, action) => ({ ...state,
    walletIsEncrypted: action.result
  }),
  [ACTIONS.WALLET_ENCRYPT_START]: (state: WalletState) => ({ ...state,
    walletEncryptPending: true,
    walletEncryptSucceded: null,
    walletEncryptResult: null
  }),
  [ACTIONS.WALLET_ENCRYPT_COMPLETED]: (state: WalletState, action: ActionResult) => ({ ...state,
    walletEncryptPending: false,
    walletEncryptSucceded: true,
    walletEncryptResult: action.result
  }),
  [ACTIONS.WALLET_ENCRYPT_FAILED]: (state: WalletState, action: ActionResult) => ({ ...state,
    walletEncryptPending: false,
    walletEncryptSucceded: false,
    walletEncryptResult: action.result
  }),
  [ACTIONS.WALLET_DECRYPT_START]: (state: WalletState) => ({ ...state,
    walletDecryptPending: true,
    walletDecryptSucceded: null,
    walletDecryptResult: null
  }),
  [ACTIONS.WALLET_DECRYPT_COMPLETED]: (state: WalletState, action: ActionResult) => ({ ...state,
    walletDecryptPending: false,
    walletDecryptSucceded: true,
    walletDecryptResult: action.result
  }),
  [ACTIONS.WALLET_DECRYPT_FAILED]: (state: WalletState, action: ActionResult) => ({ ...state,
    walletDecryptPending: false,
    walletDecryptSucceded: false,
    walletDecryptResult: action.result
  }),
  [ACTIONS.WALLET_UNLOCK_START]: (state: WalletState) => ({ ...state,
    walletUnlockPending: true,
    walletUnlockSucceded: null,
    walletUnlockResult: null
  }),
  [ACTIONS.WALLET_UNLOCK_COMPLETED]: (state: WalletState, action: ActionResult) => ({ ...state,
    walletUnlockPending: false,
    walletUnlockSucceded: true,
    walletUnlockResult: action.result
  }),
  [ACTIONS.WALLET_UNLOCK_FAILED]: (state: WalletState, action: ActionResult) => ({ ...state,
    walletUnlockPending: false,
    walletUnlockSucceded: false,
    walletUnlockResult: action.result
  }),
  [ACTIONS.WALLET_LOCK_START]: (state: WalletState) => ({ ...state,
    walletLockPending: false,
    walletLockSucceded: null,
    walletLockResult: null
  }),
  [ACTIONS.WALLET_LOCK_COMPLETED]: (state: WalletState, action: ActionResult) => ({ ...state,
    walletLockPending: false,
    walletLockSucceded: true,
    walletLockResult: action.result
  }),
  [ACTIONS.WALLET_LOCK_FAILED]: (state: WalletState, action: ActionResult) => ({ ...state,
    walletLockPending: false,
    walletLockSucceded: false,
    walletLockResult: action.result
  }),
  [ACTIONS.SET_TRANSACTION_LIST_FILTER]: (state: WalletState, action: {
    data: string;
  }) => ({ ...state,
    transactionListFilter: action.data
  }),
  [ACTIONS.UPDATE_CURRENT_HEIGHT]: (state: WalletState, action: {
    data: number;
  }) => ({ ...state,
    latestBlock: action.data
  }),
  [ACTIONS.WALLET_RESTART]: (state: WalletState) => ({ ...state,
    walletReconnecting: true
  }),
  [ACTIONS.WALLET_RESTART_COMPLETED]: (state: WalletState) => ({ ...state,
    walletReconnecting: false
  })
}, defaultState);
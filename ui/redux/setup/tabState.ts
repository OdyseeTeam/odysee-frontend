...
const watchHistoryActions = [ACTIONS.SET_CONTENT_POSITION, ACTIONS.SET_CONTENT_LAST_VIEWED, ACTIONS.CLEAR_CONTENT_HISTORY_URI, ACTIONS.CLEAR_CONTENT_HISTORY_ALL];
...
const whitelist = [...triggerSharedStateActions, ACTIONS.CLIENT_SETTING_CHANGED, ACTIONS.NOTIFICATION_DELETE_COMPLETED, ACTIONS.NOTIFICATION_SEEN_COMPLETED, ACTIONS.USER_LOGGED_IN_BROADCAST, ...watchHistoryActions];

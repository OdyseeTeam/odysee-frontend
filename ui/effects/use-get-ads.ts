...
export function useGetAds(approvedVideo: boolean, adsEnabled: boolean): [string | null | undefined, (arg0: string | null | undefined) => void, boolean] {

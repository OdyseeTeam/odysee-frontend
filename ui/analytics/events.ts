...
export type Events = {
  ...
  playerLoaded: (arg0: string, arg1: boolean | null | undefined) => void;
  playerVideoStarted: (arg0: boolean | null | undefined) => void;
  purchase: (arg0: number) => void;
  rewardEligible: () => void;
  startup: (time: number) => void;
  tagFollow: (arg0: string, arg1: boolean, arg2: string | null | undefined) => void;
...
// ****************************************************************************
// ****************************************************************************
function sendGaEvent(event: string, params?: Record<string, string | number>) {
  if (gGoogleAnalyticsOn) {

...
export const PUBLISH_TIMEOUT_BUT_LIKELY_SUCCESSFUL =
  'There was a network error, but the publish may have been completed. Wait a few minutes, then check your Uploads or Wallet page to confirm.';
export const PUBLISH_TIMEOUT =
  'Your upload timed out. If the issue persists, we recommmend trying to upload on the website version of Odysee, while we are working on this. Sorry for the trouble.';
...
export const RESTRICTED_CONTENT_PUBLISHING_FAILED =

...
export const SET_ASSIGNED_LBRYNET_SERVER = 'SET_ASSIGNED_LBRYNET_SERVER';
// Navigation
...
// Wallet
export const ARCONNECT_DISCONNECT = 'ARCONNECT_DISCONNECT';
export const ARCONNECT_STARTED = 'ARCONNECT_START';
export const ARCONNECT_SUCCESS = 'ARCONNECT_SUCCESS';
export const ARCONNECT_FAILURE = 'ARCONNECT_FAILURE';
export const ARCONNECT_FETCHBALANCE = 'ARCONNECT_FETCHBALANCE';
export const ARSETEXCHANGERATE = 'ARSETEXCHANGERATE';
export const WANDER_AUTH = 'WANDER_AUTH';
export const AR_TIP_STATUS_STARTED = 'AR_TIP_STATUS_STARTED';
export const AR_TIP_STATUS_ERROR = 'AR_TIP_STATUS_ERROR';
export const AR_TIP_STATUS_SUCCESS = 'AR_TIP_STATUS_SUCCESS';
export const AR_SEND_STARTED = 'AR_SEND_STARTED';
export const AR_SEND_SUCCESS = 'AR_SEND_SUCCESS';
export const AR_SEND_ERROR = 'AR_SEND_ERROR';
export const AR_ADDR_REGISTER_STARTED = 'AR_ADDR_REGISTER_STARTED';
export const AR_ADDR_REGISTER_CLEAR = 'AR_ADDR_REGISTER_CLEAR';
...
export const SET_COLLECTION_LAST_PLAYED_URI = 'SET_COLLECTION_LAST_PLAYED_URI';
...
export const FETCH_VIEW_HISTORY_STARTED = 'FETCH_VIEW_HISTORY_STARTED';
export const FETCH_VIEW_HISTORY_COMPLETED = 'FETCH_VIEW_HISTORY_COMPLETED';
export const FETCH_VIEW_HISTORY_FAILED = 'FETCH_VIEW_HISTORY_FAILED';
...
export const COLLECTION_PUBLISH_START = 'COLLECTION_PUBLISH_START';
export const COLLECTION_PUBLISH_SUCCESS = 'COLLECTION_PUBLISH_SUCCESS';
export const COLLECTION_PUBLISH_FAIL = 'COLLECTION_PUBLISH_FAIL';
export const COLLECTION_AUTOPUBLISH_SET = 'COLLECTION_AUTOPUBLISH_SET';
export const COLLECTION_AUTOPUBLISH_SCHEDULED = 'COLLECTION_AUTOPUBLISH_SCHEDULED';
...
export const USER_ODYSEE_PREMIUM_CHECK_STARTED = 'USER_ODYSEE_PREMIUM_CHECK_STARTED';
export const USER_ODYSEE_PREMIUM_CHECK_SUCCESS = 'USER_ODYSEE_PREMIUM_CHECK_SUCCESS';
export const USER_ODYSEE_PREMIUM_CHECK_FAILURE = 'USER_ODYSEE_PREMIUM_CHECK_FAILURE';
export const USER_LEGACY_ODYSEE_PREMIUM_CHECK_STARTED = 'USER_LEGACY_ODYSEE_PREMIUM_CHECK_STARTED';
export const USER_LEGACY_ODYSEE_PREMIUM_CHECK_SUCCESS = 'USER_LEGACY_ODYSEE_PREMIUM_CHECK_SUCCESS';
export const USER_LEGACY_ODYSEE_PREMIUM_CHECK_FAILURE = 'USER_LEGACY_ODYSEE_PREMIUM_CHECK_FAILURE';
// Referrer
...
export const SET_MEMBERSHIP_BUY_CLEAR = 'SET_MEMBERSHIP_BUY_CLEAR';
...
export const MEMBERSHIP_TX_INCOMING_STARTED = 'MEMBERSHIP_TX_INCOMING_STARTED';
export const MEMBERSHIP_TX_INCOMING_SUCCESSFUL = 'MEMBERSHIP_TX_INCOMING_SUCCESSFUL';
export const MEMBERSHIP_TX_INCOMING_FAILED = 'MEMBERSHIP_TX_INCOMING_FAILED';
export const MEMBERSHIP_TX_OUTGOING_STARTED = 'MEMBERSHIP_TX_OUTGOING_STARTED';
export const MEMBERSHIP_TX_OUTGOING_SUCCESSFUL = 'MEMBERSHIP_TX_OUTGOING_SUCCESSFUL';
export const MEMBERSHIP_TX_OUTGOING_FAILED = 'MEMBERSHIP_TX_OUTGOING_FAILED';
...
export const REMOVE_PENDING_CLAIM_BY_ID = 'REMOVE_PENDING_CLAIM_BY_ID';
export const PUBLISH_PIPELINE_ADD = 'PUBLISH_PIPELINE_ADD';
export const PUBLISH_PIPELINE_UPDATE = 'PUBLISH_PIPELINE_UPDATE';
export const PUBLISH_PIPELINE_REMOVE = 'PUBLISH_PIPELINE_REMOVE';
export const PUBLISH_SAVE_FORM = 'PUBLISH_SAVE_FORM';
export const PUBLISH_RESTORE_FORM = 'PUBLISH_RESTORE_FORM';
export const PUBLISH_SET_ACTIVE_FORM = 'PUBLISH_SET_ACTIVE_FORM';
...
export const GET_SYNC_DEFERRED = 'GET_SYNC_DEFERRED';
...
export const LAST_SYNC_HASH_UPDATED = 'LAST_SYNC_HASH_UPDATED';
...
export const SYNC_DEFERRED_SET = 'SYNC_DEFERRED_SET';
export const HISTORIC_VICTIM_RECOVERED = 'HISTORIC_VICTIM_RECOVERED';
...
// ArConnect
export const CONNECT_AR_CONNECT = 'CONNECT_AR_CONNECT';
export const DISCONNECT_AR_CONNECT = 'DISCONNECT_AR_CONNECT';
export const CHECK_AR_CONNECT_STATUS = 'CHECK_AR_CONNECT_STATUS';
// Shorts
export const TOGGLE_SHORTS_SIDE_PANEL = 'TOGGLE_SHORTS_SIDE_PANEL';
export const SET_SHORTS_SIDE_PANEL = 'SET_SHORTS_SIDE_PANEL';
export const SET_SHORTS_PLAYLIST = 'SET_SHORTS_PLAYLIST';
export const CLEAR_SHORTS_PLAYLIST = 'CLEAR_SHORTS_PLAYLIST';
export const SET_SHORTS_VIEW_MODE = 'SET_SHORTS_VIEW_MODE';
export const SET_SHORTS_AUTOPLAY = 'SET_SHORTS_AUTOPLAY';
export const TOGGLE_SHORTS_AUTOPLAY = 'TOGGLE_SHORTS_AUTOPLAY';

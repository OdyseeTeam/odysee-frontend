export const DEFAULT_FOLLOWED_TAGS = ['art', 'automotive', 'blockchain', 'comedy', 'economics', 'education', 'gaming', 'music', 'news', 'science', 'sports', 'technology'];
...
export const SCHEDULED_TAGS = Object.freeze({
  HIDE: 'c:scheduled:hide',
  // Regular claim + hide from Upcoming section
  SHOW: 'c:scheduled:show',
  // Regular claim + show in Upcoming Section
  LIVE: 'c:scheduled-livestream' // Livestream

});
// Control tags are special tags that are available to the user in some situations.
export const CONTROL_TAGS = [DISABLE_SUPPORT_TAG, DISABLE_COMMENTS_TAG, DISABLE_DOWNLOAD_BUTTON_TAG, DISABLE_REACTIONS_VIDEO_TAG, DISABLE_REACTIONS_COMMENTS_TAG, DISABLE_SLIMES_VIDEO_TAG, DISABLE_SLIMES_COMMENTS_TAG];
...
export const INTERNAL_TAGS = [...CONTROL_TAGS, ...SYSTEM_TAGS, ...MEMBERS_ONLY_TAGS, PREFERENCE_EMBED, DISABLE_REACTIONS_ALL_TAG, DISABLE_SLIMES_ALL_TAG];
export const MATURE_TAGS = Object.freeze(['porn', 'porno', 'nsfw', 'mature', 'xxx', 'sex', 'creampie', 'blowjob', 'handjob', // 'vagina',
'boobs', 'big boobs', 'big dick', 'pussy', 'cumshot', 'anal', 'hard fucking', 'ass', 'fuck', 'hentai']);

...
export const HIDE_SEARCH_CHANNELS = 'hide_search_channels';
...
export const CHAPTERS_CARD_VISIBLE = 'chapters_card_visible';
...
export const ENABLE_BROWSER_STREAM = 'enable_browser_stream';

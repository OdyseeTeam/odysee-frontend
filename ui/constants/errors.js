...
export const PUBLISH_TIMEOUT = 'Your upload timed out. If the issue persists, we recommmend trying to upload on the website version of Odysee, while we are working on this. Sorry for the trouble.';

  ...
  switch (category) {
    ...
    case 'FLAGS':
      return [
        ...
        buildTwemote('flag_uganda', `flags/flag_uganda.png`, '🇺🇬'), // buildTwemote('flag_us_outlying_islands', `flags/flag_us_outlying_islands.png`, '🇺🇲'),
...
function buildTwemoteArray(Twemotes): Array<Record<string, any>> {
  return []

...
const middleware = [sharedStateMiddleware, populateAuthTokenHeader, routerMiddleware(history), thunk, createBulkThunkMiddleware(), // BATCH_ACTIONS support
createAnalyticsMiddleware(), tabStateSyncMiddleware];
const store = createStore(enableBatching(persistedReducer), {}, // initial state

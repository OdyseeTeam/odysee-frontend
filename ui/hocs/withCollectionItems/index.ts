...
import { selectHasPrivateCollectionForId, selectUrlsForCollectionId, selectUrlsForCollectionIdNonDeleted, selectClaimIdsForCollectionId, selectCollectionHasItemsResolvedForId } from "redux/selectors/collections";
...
const select = (state, props) => {
  ...
  return {
    ...
    collectionUrls: collectionId === COLLECTIONS_CONSTS.WATCH_LATER_ID ? selectUrlsForCollectionIdNonDeleted(state, collectionId) : selectUrlsForCollectionId(state, collectionId),

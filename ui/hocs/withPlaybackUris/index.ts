...
import { selectNextUriForUriInPlayingCollectionForId, selectPreviousUriForUriInPlayingCollectionForId, selectIndexForUriInPlayingCollectionForId } from "redux/selectors/collections";
...
const select = (state, props) => {
  ...
  return {
    nextPlaylistUri: playingCollectionId && selectNextUriForUriInPlayingCollectionForId(state, playingCollectionId, uri),
    previousListUri: playingCollectionId && selectPreviousUriForUriInPlayingCollectionForId(state, playingCollectionId, uri),
    ...
    currentPlaylistItemIndex: playingCollectionId && selectIndexForUriInPlayingCollectionForId(state, playingCollectionId, uri),

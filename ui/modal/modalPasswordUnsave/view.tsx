...
class ModalPasswordUnsave extends React.PureComponent<Props> {
  render() {
    return <Modal isOpen contentLabel={__('Unsave Password')} title={__('Clear saved password')} type="confirm" confirmButtonLabel={__('Forget')} abortButtonLabel={__('Nevermind')} onConfirmed={() => deleteSavedPassword().then(() => {

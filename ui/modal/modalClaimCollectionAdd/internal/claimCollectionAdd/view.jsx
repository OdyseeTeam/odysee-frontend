...
const ClaimCollectionAdd = (props: Props) => {
  ...
  const unpublishedCollections = ((Object.values(unpublished): any): Array<Collection>);
  const publishedCollections = published ? ((Object.values(published): any): Array<Collection>) : [];

...
class ModalFirstReward extends React.PureComponent<Props> {
  render() {
    ...
    return <Modal type="card" isOpen contentLabel={__('Your first credit')}>
        <Card title={__('Your first credit')} subtitle={__('You just received your first credit!')} body={<React.Fragment>
            ...
            </React.Fragment>} actions={<Button button="primary" onClick={closeModal} label={__('You Got It Dude')} />} />
      </Modal>;
  }

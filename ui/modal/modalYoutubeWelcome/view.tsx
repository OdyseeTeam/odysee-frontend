...
const YoutubeWelcome = (props: Props) => {
  ...
  return <Modal isOpen type="card" onAborted={doHideModal}>
      <Confetti recycle={false} style={{
      position: 'fixed'
    }} numberOfPieces={100} />
      <Card title={!SIMPLE_SITE ? __("You're free!") : __('Welcome to Odysee')} subtitle={!SIMPLE_SITE ? <React.Fragment>
              <p>
            ...
            </React.Fragment>} actions={<div className="card__actions">
            <Button button="primary" label={__('Create an Account')} navigate={`/$/${PAGES.AUTH}`} onClick={doHideModal} />

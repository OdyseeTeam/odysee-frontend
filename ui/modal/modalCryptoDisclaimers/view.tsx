...
export default function ModalCryptoDisclaimers(props: Props) {
  ...
  return <Modal className="cryptoDisclaimersModal" type="card" isOpen onAborted={doHideModal}>
      ...
      <FormField type="checkbox" name="show_crypto_disclaimers" label={__('Don’t show me this message again')} checked={!showDisclaimers} onChange={handleShowDisclaimers} />

...
const InlineMessage = (props: InlineMessageProps) => {
  ...
  return <div className="notifications-blocked">
...
export const BrowsernotificationsBlocked = () => {
  return <InlineMessage title={__('Heads up: browser notifications are currently blocked in this browser.')}>
...
export const BrowserNotificationHints = () => {
  return <InlineMessage title={__("Browser notifications aren't supported. Here's a few tips:")}>

  ...
  return <>
      <div className="browser-notifications__banner notice-message">
        ...
        <div className="browser-notifications__actions">
          <Button className="browser-notifications__button" button="primary" title={__('Enable Push Notifications')} label={__('Enable Push Notifications')} onClick={pushToggle} />

...
const SeniorAndroidDeveloperPage = () => {
  return <Page>
      <Card body={<>
          ...
          marginBottom: '10px'
              ...
              <p>
                We are looking for an ambitious and self-driven Android Developer to join our team. As a Senior Android
                Developer, you will be responsible for designing and delivering the Odysee Android app. Your role will
                be critical in creating an intuitive and user friendly user experience for all of the creators and
                viewers that use Odysee on Android. At Odysee, you will be welcomed into a supportive and friendly
                (virtual) team and you will have the chance to lead many critical projects as they pertain to mobile.
                Odysee.com is the largest blockchain media platform in the world; after launching in December 2020,
                Odysee has been scaling significantly and is now looking to add a Senior Android Developer with modern
                design aesthetics and who is an avid media junkie to its ranks.
              </p>
            </section>
            ...
            <section className="section card--section">
              ...
              <ul>
                ...
                <li>
                  Creating amazing user experiences for all Android enabled devices from a minimal set of requirements
            ...
            <section className="section card--section">
              ...
              <ul>
                <li>5+ years of recent experience as an Android Developer</li>
                <li>Excellent knowledge of mobile troubleshooting and debugging practices and techniques</li>
                <li>You have published at least one or more Android apps in the Play store</li>
                <li>

// Config module - reads from process.env which Vite's `define` injects at build time.
// For server-side usage (web/index.ts, web/src/html.ts), config.js is used instead.
...
export const {
  MINIMUM_VERSION, IGNORE_MINIMUM_VERSION, WEBPACK_WEB_PORT, WEBPACK_ELECTRON_PORT,
  WEB_SERVER_PORT, LBRY_WEB_API, LBRY_WEB_API_NO_CF, LBRY_WEB_PUBLISH_API,
  LBRY_WEB_PUBLISH_API_V2, LBRY_WEB_PUBLISH_API_V3, LBRY_WEB_PUBLISH_API_V4,
  LBRY_API_URL, LBRY_WEB_BUFFER_API, SEARCH_SERVER_API, SEARCH_SERVER_API_ALT,
  COMMENT_SERVER_API, LIVESTREAM_SERVER_API, SHORT_URL_API, SOCKETY_SERVER_API,
  LOCALE_API, GEO_BLOCK_API, WELCOME_VERSION, DOMAIN, SHARE_DOMAIN_URL, URL,
  RECSYS_ENDPOINT, RECSYS_FYP_ENDPOINT, IMAGE_PROXY_URL, THUMBNAIL_CDN_URL,
  THUMBNAIL_CARDS_CDN_URL, THUMBNAIL_HEIGHT, THUMBNAIL_HEIGHT_POSTER,
  THUMBNAIL_WIDTH, THUMBNAIL_WIDTH_POSTER, THUMBNAIL_QUALITY,
  THUMBNAIL_CDN_SIZE_LIMIT_BYTES, PLAYER_SERVER, SITE_TITLE, SITE_NAME,
  SITE_DESCRIPTION, SITE_HELP_EMAIL, TWITTER_ACCOUNT, LOGO_TITLE, LOGO,
  LOGO_WHITE_TEXT, LOGO_DARK_TEXT, AVATAR_DEFAULT, MISSING_THUMB_DEFAULT,
  OG_TITLE_SUFFIX, OG_HOMEPAGE_TITLE, OG_IMAGE_URL, YRBL_HAPPY_IMG_URL,
  YRBL_SAD_IMG_URL, LOGIN_IMG_URL, SITE_CANONICAL_URL, DEFAULT_LANGUAGE,
  AUTO_FOLLOW_CHANNELS, UNSYNCED_SETTINGS, ENABLE_COMMENT_REACTIONS,
  ENABLE_FILE_REACTIONS, ENABLE_CREATOR_REACTIONS, ENABLE_NO_SOURCE_CLAIMS,
  ENABLE_PREROLL_ADS, CHANNEL_STAKED_LEVEL_VIDEO_COMMENTS, CHANNEL_CREATION_LIMIT,
  WEB_PUBLISH_SIZE_LIMIT_GB, LOADING_BAR_COLOR, SIMPLE_SITE, SHOW_ADS,
  KNOWN_APP_DOMAINS, STRIPE_PUBLIC_KEY, ENABLE_UI_NOTIFICATIONS, ENABLE_MATURE,
  CUSTOM_HOMEPAGE, SHOW_TAGS_INTRO, LIGHTHOUSE_DEFAULT_TYPES, BRANDED_SITE,
  ENABLE_STRIPE, ENABLE_ARCONNECT, ENABLE_STABLECOIN, FIREBASE_API_KEY,
  ...
  FIREBASE_VAPID_KEY, AD_KEYWORD_BLOCKLIST, AD_KEYWORD_BLOCKLIST_CHECK_DESCRIPTION,
  COMMIT_ID, NODE_ENV, DYNAMIC_ROUTES_FIRST, SDK_API_PATH, PROXY_URL,
  PROXY_URL_NO_CF, URL_DEV, URL_LOCAL, FAVICON, FAVICON_NOTIFICATION,
  FARCASTER_ACCOUNT_ASSOC_HEADER, FARCASTER_ACCOUNT_ASSOC_PAYLOAD,
  FARCASTER_ACCOUNT_ASSOC_SIGNATURE, FARCASTER_ICON_URL,
  FARCASTER_SPLASH_IMAGE_URL, FARCASTER_SPLASH_BACKGROUND_COLOR,

...
const config: Record<string, any> = {
  ...
  LIVESTREAM_INGEST_HOST: process.env.LIVESTREAM_INGEST_HOST,
  LIVESTREAM_WEBRTC_PORT: process.env.LIVESTREAM_WEBRTC_PORT,
  LIVESTREAM_WHIP_URL_TEMPLATE: process.env.LIVESTREAM_WHIP_URL_TEMPLATE,
  ...
  HYPERBEAM_PLAYBACK_URL: process.env.HYPERBEAM_PLAYBACK_URL,
  HYPERBEAM_BASE_URL: process.env.HYPERBEAM_BASE_URL,
...
export const {
  ...
  LBRY_WEB_API,
  LBRY_WEB_API_NO_CF,
  LBRY_WEB_PUBLISH_API,
  LBRY_WEB_PUBLISH_API_V2,
  LBRY_WEB_PUBLISH_API_V3,
  LBRY_WEB_PUBLISH_API_V4,
  LBRY_API_URL,
  LBRY_WEB_BUFFER_API,
  SEARCH_SERVER_API,
  ...
  THUMBNAIL_QUALITY,
  THUMBNAIL_CDN_SIZE_LIMIT_BYTES,
  PLAYER_SERVER,
  ...
  ENABLE_PREROLL_ADS,
  CHANNEL_STAKED_LEVEL_VIDEO_COMMENTS,
  ...
  FIREBASE_VAPID_KEY,
  AD_KEYWORD_BLOCKLIST,
  AD_KEYWORD_BLOCKLIST_CHECK_DESCRIPTION,
  COMMIT_ID,
  NODE_ENV,
  DYNAMIC_ROUTES_FIRST,
  SDK_API_PATH,
  PROXY_URL,
  PROXY_URL_NO_CF,
  URL_DEV,

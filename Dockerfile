...
COPY --from=build /app/node_modules/dotenv-defaults node_modules/dotenv-defaults
COPY --from=build /app/node_modules/dotenv node_modules/dotenv
COPY --from=build /app/node_modules/proxy-polyfill node_modules/proxy-polyfill
COPY --from=build /app/node_modules/dayjs node_modules/dayjs
COPY --from=build /app/node_modules/rss node_modules/rss
COPY --from=build /app/node_modules/xml node_modules/xml
COPY --from=build /app/node_modules/mime-types node_modules/mime-types
COPY --from=build /app/node_modules/mime-db node_modules/mime-db

# Built frontend assets from build stage
COPY --from=build /app/web/dist web/dist

# Web server code
COPY web/index.js web/lbry.js web/
...
COPY config.cjs .env.defaults ./
COPY ui/util/web.cjs ui/util/
COPY ui/constants/pages.cjs ui/constants/
COPY custom/homepages custom/homepages
COPY static static

RUN chown -R odysee:odysee /app
USER odysee

!(function () {
  ...
  class r {
    constructor(e) {
      ((this._wasmModule = e), (this._runCode = e.runCode), (this._file = null), (this._passphrase = null));
    }
    open(e) {
    ...
    *entries(r = !1, t = null) {
      ...
      for (
        ...
        if (r && t !== o.path) this._runCode.skipEntry(this._archive);
          ...
          ((o.fileData = this._wasmModule.HEAP8.slice(e, e + o.size)), this._wasmModule._free(e));
        }
        yield o;
      }
    }
  ...
  var t,
    n =
      ((t = 'undefined' != typeof document && document.currentScript ? document.currentScript.src : void 0),
      function (e) {
        var r,
          n = void 0 !== (e = e || {}) ? e : {},
          o = {};
        ...
        i
          ...
          : a
            ...
            : (s || u) &&
              (u ? (l = self.location.href) : document.currentScript && (l = document.currentScript.src),
              t && (l = t),
          ...
          switch (e) {
            ...
            default:
              ...
              if ('i' === e[0]) {
                ...
                return (E(r % 8 == 0, 'getNativeTypeSize invalid bits ' + r + ', type ' + e), r / 8);
              }
              return 0;
          }
        }
        ...
        function g(e) {
          var r = n['_' + e];
          return (E(r, 'Cannot call unknown function ' + e + ', make sure it is exported'), r);
        }
        ...
        function S(e, r, t, n) {
          ...
          if ('i8' === s) return (e.subarray || e.slice ? T.set(e, a) : T.set(new Uint8Array(e), a), a);
          for (var c, f, l, d = 0; d < i; ) {
            var p = e[d];
            0 !== (c = s || r[d])
              ? ('i64' == c && (c = 'i32'), b(a + d, p, c), l !== c && ((f = h(c)), (l = c)), (d += f))
              : d++;
          }
          return a;
        }
        ...
        function z(e, r, t, n) {
          ...
          for (var o = t, i = t + n - 1, a = 0; a < e.length; ++a) {
            ...
            if (
              (s >= 55296 && s <= 57343 && (s = (65536 + ((1023 & s) << 10)) | (1023 & e.charCodeAt(++a))), s <= 127)
            ) {
              if (t >= i) break;
              r[t++] = s;
            } else if (s <= 2047) {
        ...
        (K < 5242880 && p('TOTAL_MEMORY should be larger than TOTAL_STACK, was ' + K + '! (TOTAL_STACK=5242880)'),
          n.buffer
            ? (A = n.buffer)
        ...
        function de(e) {
          ...
          return (
            ...
            'function' != typeof fetch
              ? i(o)
              : WebAssembly.instantiateStreaming(fetch(fe, { credentials: 'same-origin' }), r).then(o, function (e) {
                  (p('wasm streaming compile failed: ' + e), p('falling back to ArrayBuffer instantiation'), i(o));
                }),
            {}
          );
        }
        ...
        var ve = {
          ...
          we = {
            ...
            register: function (e, r) {
              ((we.ttys[e] = { input: [], output: [], ops: r }), be.registerDevice(e, we.stream_ops));
            },
            stream_ops: {
              open: function (e) {
            ...
            default_tty_ops: {
              get_char: function (e) {
                if (!e.input.length) {
                  ...
                  if (i) {
                    ...
                    (s && Me.closeSync(a), (r = n > 0 ? t.slice(0, n).toString('utf-8') : null));
                  } else
              ...
              put_char: function (e, r) {
                null === r || 10 === r ? (d(x(e.output, 0)), (e.output = [])) : 0 != r && e.output.push(r);
              },
              flush: function (e) {
          ...
          ye = {
                ...
                be.isDir(o.mode)
                  ...
                  : be.isFile(o.mode)
                    ...
                    : be.isLink(o.mode)
                      ...
                      : be.isChrdev(o.mode) &&
                        ((o.node_ops = ye.ops_table.chrdev.node), (o.stream_ops = ye.ops_table.chrdev.stream)),
            ...
            stream_ops: {
              ...
              llseek: function (e, r, t) {
                var n = r;
                if ((1 === t ? (n += e.position) : 2 === t && be.isFile(e.node.mode) && (n += e.node.usedBytes), n < 0))
          ...
          Ee = {
            ...
            getDB: function (e, r) {
              ...
              ((t.onupgradeneeded = function (e) {
                ...
                (r = t.objectStoreNames.contains(Ee.DB_STORE_NAME)
                  ...
                  : t.createObjectStore(Ee.DB_STORE_NAME)).indexNames.contains('timestamp') ||
            ...
            getLocalSet: function (e, r) {
              ...
              for (var i = be.readdir(e.mountpoint).filter(n).map(o(e.mountpoint)); i.length; ) {
                var a,
                  s = i.pop();
                try {
                  a = be.stat(s);
                ...
                (be.isDir(a.mode) && i.push.apply(i, be.readdir(s).filter(n).map(o(s))),
              ...
              Ee.getDB(e.mountpoint, function (e, n) {
                ...
                try {
                  ...
                  ((o.onerror = function (e) {
                    ...
                    (o.objectStore(Ee.DB_STORE_NAME).index('timestamp').openKeyCursor().onsuccess = function (e) {
            ...
            reconcile: function (e, r, t) {
              ...
              if (
                ...
                return t(null);
              var a = 0,
                s = ('remote' === e.type ? e.db : r.db).transaction([Ee.DB_STORE_NAME], 'readwrite'),
                u = s.objectStore(Ee.DB_STORE_NAME);
              function c(e) {
                return e ? (c.errored ? void 0 : ((c.errored = !0), t(e))) : ++a >= n ? t(null) : void 0;
              }
              ((s.onerror = function (e) {
                ...
                i
                  ...
                  .reverse()
                  .forEach(function (e) {
                    'local' === r.type ? Ee.removeLocalEntry(e, c) : Ee.removeRemoteEntry(u, e, c);
                  }));
            },
          },
          ge = {
            ...
            createNode: function (e, r, t, n) {
              if (!be.isDir(t) && !be.isFile(t) && !be.isLink(t)) throw new be.ErrnoError(22);
            ...
            getMode: function (e) {
              var r;
              try {
                ((r = Me.lstatSync(e)), ge.isWindows && (r.mode = r.mode | ((292 & r.mode) >> 2)));
              } catch (e) {
                if (!e.code) throw e;
            ...
            flagsForNode: function (e) {
              ...
              var r = 0;
              for (var t in ge.flagsForNodeMap) e & t && ((r |= ge.flagsForNodeMap[t]), (e ^= t));
            ...
            node_ops: {
              getattr: function (e) {
                ...
                return (
                  ...
                  ge.isWindows && !r.blocks && (r.blocks = ((r.size + r.blksize - 1) / r.blksize) | 0),
                  {
                    dev: r.dev,
                    ino: r.ino,
                    mode: r.mode,
              ...
              setattr: function (e, r) {
                var t = ge.realPath(e);
                try {
                  if ((void 0 !== r.mode && (Me.chmodSync(t, r.mode), (e.mode = r.mode)), void 0 !== r.timestamp)) {
              ...
              mknod: function (e, r, t, n) {
                var o = ge.createNode(e, r, t, n),
                  i = ge.realPath(o);
                try {
                  be.isDir(o.mode) ? Me.mkdirSync(i, o.mode) : Me.writeFileSync(i, '', { mode: o.mode });
                } catch (e) {
                  if (!e.code) throw e;
                  throw new be.ErrnoError(-e.errno);
                }
              ...
              readlink: function (e) {
                var r = ge.realPath(e);
                try {
                  return ((r = Me.readlinkSync(r)), (r = Be.relative(Be.resolve(e.mount.opts.root), r)));
                } catch (e) {
                  if (!e.code) throw e;
                  throw new be.ErrnoError(-e.errno);
                }
            ...
            stream_ops: {
              open: function (e) {
                ...
                try {
                  be.isFile(e.node.mode) && (e.nfd = Me.openSync(r, ge.flagsForNode(e.flags)));
                } catch (e) {
                  if (!e.code) throw e;
                  throw new be.ErrnoError(-e.errno);
                }
          ...
          _e = {
            ...
            mount: function (e) {
              ...
              return (
                Array.prototype.forEach.call(e.opts.files || [], function (e) {
                  _e.createNode(n(e.name), o(e.name), _e.FILE_MODE, 0, e, e.lastModifiedDate);
                }),
                ...
                (e.opts.packages || []).forEach(function (e) {
                  e.metadata.files.forEach(function (r) {
                    ...
                    _e.createNode(n(t), o(t), _e.FILE_MODE, 0, e.blob.slice(r.start, r.end));
                  });
                }),
                r
              );
            ...
            createNode: function (e, r, t, n, o, i) {
              ...
              return (
                ...
                t === _e.FILE_MODE ? ((a.size = o.size), (a.contents = o)) : ((a.size = 4096), (a.contents = {})),
                e && (e.contents[r] = a),
                a
              );
            },
            ...
            stream_ops: {
              ...
              llseek: function (e, r, t) {
                var n = r;
                if ((1 === t ? (n += e.position) : 2 === t && be.isFile(e.node.mode) && (n += e.node.size), n < 0))
                  throw new be.ErrnoError(22);
                return n;
              },
            },
          ...
          be = {
            ...
            lookupPath: function (e, r) {
              if (((r = r || {}), !(e = ve.resolve(be.cwd(), e)))) return { path: '', node: null };
              ...
              for (
                ...
                if (
                  ...
                  (a = me.join2(a, o[s])),
                  be.isMountpoint(i) && (!u || (u && r.follow_mount)) && (i = i.mounted.root),
                  !u || r.follow)
                )
            ...
            lookupNode: function (e, r) {
              ...
              for (var n = be.hashName(e.id, r), o = be.nameTable[n]; o; o = o.name_next) {
                var i = o.name;
            ...
            mount: function (e, r, t) {
              ...
              if (!o && !i) {
                ...
                if (((t = a.path), (n = a.node), be.isMountpoint(n))) throw new be.ErrnoError(16);
              ...
              return (
                (u.mount = s),
                (s.root = u),
                o ? (be.root = u) : n && ((n.mounted = s), n.mount && n.mount.mounts.push(s)),
                u
              );
            },
            unmount: function (e) {
            ...
            create: function (e, r) {
              return ((r = void 0 !== r ? r : 438), (r &= 4095), (r |= 32768), be.mknod(e, r, 0));
            },
            mkdir: function (e, r) {
              return ((r = void 0 !== r ? r : 511), (r &= 1023), (r |= 16384), be.mknod(e, r, 0));
            },
            ...
            rename: function (e, r) {
              var t,
                ...
                s = me.basename(r);
              try {
                ((t = be.lookupPath(e, { parent: !0 }).node), (n = be.lookupPath(r, { parent: !0 }).node));
              } catch (e) {
              ...
              if (c !== u) {
                ...
                if ((d = u ? be.mayDelete(n, s, l) : be.mayCreate(n, s))) throw new be.ErrnoError(d);
                if (!t.node_ops.rename) throw new be.ErrnoError(1);
                if (be.isMountpoint(c) || (u && be.isMountpoint(u))) throw new be.ErrnoError(16);
                if (n !== t && (d = be.nodePermissions(t, 'w'))) throw new be.ErrnoError(d);
                be.hashRemoveNode(c);
                try {
            ...
            chmod: function (e, r, t) {
              var n;
              if (!(n = 'string' == typeof e ? be.lookupPath(e, { follow: !t }).node : e).node_ops.setattr)
                throw new be.ErrnoError(1);
            ...
            chown: function (e, r, t, n) {
              var o;
              if (!(o = 'string' == typeof e ? be.lookupPath(e, { follow: !n }).node : e).node_ops.setattr)
                throw new be.ErrnoError(1);
            ...
            truncate: function (e, r) {
              ...
              var t;
              if (!(t = 'string' == typeof e ? be.lookupPath(e, { follow: !0 }).node : e).node_ops.setattr)
                throw new be.ErrnoError(1);
            ...
            open: function (e, r, t, o, i) {
              ...
              if (
                ((t = void 0 === t ? 438 : t),
                (t = 64 & (r = 'string' == typeof r ? be.modeStringToFlags(r) : r) ? (4095 & t) | 32768 : 0),
                'object' == typeof e)
              )
                a = e;
              else {
              ...
              if ((be.isChrdev(a.mode) && (r &= -513), 65536 & r && !be.isDir(a.mode))) throw new be.ErrnoError(20);
              if (!s) {
              ...
              return (
                ...
                !n.logReadFiles ||
                  ...
                  e in be.readFiles ||
                    ((be.readFiles[e] = 1), console.log('FS.trackingDelegate error on read file: ' + e))),
                c
              );
            },
            close: function (e) {
            ...
            write: function (e, r, t, n, o, i) {
              ...
              a || (e.position += s);
              try {
                e.path && be.trackingDelegate.onWriteToFile && be.trackingDelegate.onWriteToFile(e.path);
              } catch (r) {
                console.log("FS.trackingDelegate['onWriteToFile']('" + e.path + "') threw an exception: " + r.message);
              }
              return s;
            },
            allocate: function (e, r, t) {
              ...
              if (0 == (2097155 & e.flags)) throw new be.ErrnoError(9);
              if (!be.isFile(e.node.mode) && !be.isDir(e.node.mode)) throw new be.ErrnoError(19);
            ...
            readFile: function (e, r) {
              ...
              return (
                be.read(n, i, 0, o, 0),
                'utf8' === r.encoding ? (t = x(i, 0)) : 'binary' === r.encoding && (t = i),
                be.close(n),
                t
              );
            },
            ...
            createStandardStreams: function () {
              (n.stdin ? be.createDevice('/dev', 'stdin', n.stdin) : be.symlink('/dev/tty', '/dev/stdin'),
                n.stdout ? be.createDevice('/dev', 'stdout', null, n.stdout) : be.symlink('/dev/tty', '/dev/stdout'),
                n.stderr ? be.createDevice('/dev', 'stderr', null, n.stderr) : be.symlink('/dev/tty1', '/dev/stderr'),
                be.open('/dev/stdin', 'r'),
            ...
            forceLoadFile: function (e) {
              ...
              if (!n.read) throw new Error('Cannot load without read() or XMLHttpRequest.');
              try {
                  ...
                  (e.forEach(function (e) {
                    ...
                    ((r.onsuccess = function () {
                      (be.analyzePath(e).exists && be.unlink(e),
                        be.createDataFile(me.dirname(e), me.basename(e), r.result, !0, !0, !0),
                        ++s + u == c && f());
                    }),
                      (r.onerror = function () {
                        s + ++u == c && f();
          ...
          ke = {
            ...
            doStat: function (e, r, t) {
              try {
                ...
                if (e && e.node && me.normalize(r) !== me.normalize(be.getPath(e.node))) return -20;
                throw e;
              }
              return (
                (M[t >> 2] = n.dev),
            ...
            doMkdir: function (e, r) {
              return (
                '/' === (e = me.normalize(e))[e.length - 1] && (e = e.substr(0, e.length - 1)), be.mkdir(e, r, 0), 0
              );
            },
            ...
            doAccess: function (e, r) {
              ...
              var n = '';
              return (
                4 & r && (n += 'r'), 2 & r && (n += 'w'), 1 & r && (n += 'x'), n && be.nodePermissions(t, n) ? -13 : 0
              );
            },
          ...
          Fe = {
            ...
            stream_ops: {
              ...
              read: function (e, r, t, n, o) {
                ...
                return (
                  d && d == i.buckets.length && (d--, (i.buckets[d].offset = 0), (i.buckets[d].roffset = 0)),
              ...
              write: function (e, r, t, n, o) {
                ...
                for (
                  var f = (a.byteLength / Fe.BUCKET_BUFFER_SIZE) | 0, l = a.byteLength % Fe.BUCKET_BUFFER_SIZE, d = 0;
                  d < f;
                  d++
                ) {
                  var p = {
            ...
            nextname: function () {
              return (Fe.nextname.current || (Fe.nextname.current = 0), 'pipe[' + Fe.nextname.current++ + ']');
            },
          };
        function Ae() {
          return R.length;
        ...
        function Re(e) {
          ...
          for (var t = Math.max(r, 16777216); t < e; )
            t = t <= 536870912 ? H(2 * t, 65536) : Math.min(H((3 * t + 2147483648) / 4, 65536), 2147418112);
          return (
            !!(function (e) {
              e = H(e, 65536);
              var r = A.byteLength;
        ...
        var Oe = {
            ...
            G: function e(r) {
              ...
              for (var c = 0; c < i.length; c++) (U((u = i[c]), t), (M[(o + 4 * c) >> 2] = t), (t += u.length + 1));
              M[(o + 4 * i.length) >> 2] = 0;
            },
            l: he,
            s: function (e, r) {
            ...
            p: function (e, r) {
              ke.varargs = r;
              try {
                for (var t = ke.get(), n = ke.get(), o = (ke.get(), 0), i = 0; i < n; i++) {
                  var a = t + 8 * i,
                    s = M[a >> 2],
                    u = P[(a + 4) >> 1],
                    c = 32,
                    f = be.getStream(s);
                  (f && ((c = ke.DEFAULT_POLLMASK), f.stream_ops.poll && (c = f.stream_ops.poll(f))),
                    (c &= 24 | u) && o++,
                    (P[(a + 6) >> 1] = c));
                }
                return o;
            ...
            f: function (e) {
              !(function (e, r) {
                (r && n.noExitRuntime && 0 === e) ||
                  (n.noExitRuntime || ((y = !0), n.onExit && n.onExit(e)), n.quit(e, new qe(e)));
              })(e);
            },
            x: function (e) {
              return (function (e, r) {
        ...
        function Ke(e) {
          function r() {
            n.calledRun ||
              ...
              y ||
                ($ ||
                  (($ = !0), n.noFSInit || be.init.initialized || be.init(), (Fe.root = be.mount(Fe, {}, null)), Z(X)),
      ...
      try {
        switch (e.type) {
          ...
          case 'EXTRACT_SINGLE_FILE':
            for (const r of i.entries(!0, e.target)) r.fileData && self.postMessage({ type: 'FILE', entry: r });
            break;
          case 'CHECK_ENCRYPTION':
            self.postMessage({ type: 'ENCRYPTION_STATUS', status: i.hasEncryptedData() });
            break;
          case 'SET_PASSPHRASE':
            (i.setPassphrase(e.passphrase), self.postMessage({ type: 'PASSPHRASE_STATUS', status: !0 }));
            break;
          default:
